...
4. 运行 `python tools/wand_eval_tree/exhaust_wands.py` 开始生成组合。
...
🔗 **[Live Tool (Online Query)](https://asmallhamis.github.io/BURST_8-DIVIDE_10-DIVIDE_3-ADD_TRIGGER-DIVIDE_4-DIVIDE_2-TAU-FLY_DOWNWARDS/)**
...
## Deployment
Designed for static hosting like GitHub Pages. Upload all files to run at zero cost.
